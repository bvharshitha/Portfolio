...
const experiences = {
    job1:  "<h2>Software Engineer</h2><p>09/2025 - Current</p><br><ul style='font-weight:lighter;'><li>Currently developing scalable Java 17 microservices using Spring Boot, integrating them with internal systems through REST APIs and ensuring secure communication with Spring Security and JWT.</li> <li>Working with Kafka, RabbitMQ, and Redis to enable real-time data streaming, asynchronous processing, and optimized database performance across distributed environments.</li><ul>",
    job2: "<h2>Volunteer Research Assistant</h2><p>05/2025 - 08/2025</p><br><ul style='font-weight:lighter;'><li><b> Project 1: Capture the Flag (CTF) Infrastructure Deployment</b><br>Migrated and redeployed the Capture the Flag (CTF) environment by setting up the CTFd platform, configuring Nginx and MariaDB, and hosting web-based challenges securely on a new system.</li><ul>",
    job3: "<h2>Software Engineer</h2><p>07/2024 - 05/2025</p><br><ul style='font-weight:lighter;'><li> <b>Working on UTA department website</b>, it is in the development phase. The website aims to serve as a simplified portal for UTA's resources, enabling faculty to easily access information related to labs and system-related inquiries.</li><li><b>Perform system administration tasks</b>, including monitoring server status, maintaining lab environments, and implementing encryption protocols and antivirus solutions on Linux systems (Debian and RPM).</li><ul>",
    job4: "<h2>Associate Software Engineer</h2><p>01/2023 - 12/2023</p><br><ul style='font-weight:lighter;'><li>Developed and optimized scalable microservices and RESTful APIs, improving onboarding time by 30% and query execution speed by 25%.</li><li>Implemented CI/CD pipelines with Jenkins and Docker on AWS infrastructure, ensuring zero-downtime deployments and enhanced system reliability.</li><ul>"
};
